...
class OrganisationsControllerTest < ActionController::TestCase
  ...
  test "should create organisation" do
    assert_difference('Organisation.count') do
      post :create, organisation: { email: @organisation.email, password: @organisation.password, password_confirmation: @organisation.password_confirmation }
    end
  ...
  test "should update organisation" do
    patch :update, id: @organisation, organisation: { email: @organisation.email, password: @organisation.password, password_confirmation: @organisation.password_confirmation }
    assert_redirected_to organisation_path(assigns(:organisation))
  end
